...
- codice: il NOSTRO codice articolo Tirelli. Regole precise:
  ...
  * Se nella descrizione/corpo della riga appare la dicitura "Vs. Codice Prodotto:", "Vs. Codice:", "Vostro Codice Prodotto:" seguita da un codice alfanumerico, usa QUEL codice come nostro codice Tirelli (es. "Vs. Codice Prodotto: C26009" -> codice=C26009). Il codice materiale nella colonna principale e quello del fornitore: IGNORALO.
...
3. Il codice articolo e SEMPRE il nostro (Tirelli): cerca "Vs. Codice", "Codice Cliente", "Vs. Codice Prodotto:" nel testo della riga, o la seconda riga in celle con doppio codice sovrapposto (es. colonna "CODICE ARTICOLO/VS CODICE") prima di usare il codice del fornitore
